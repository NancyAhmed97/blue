...
import MycontactContainer from '../components/MycontactContainer/MycontactContainer'
    ...
    <div>
        ...
        <Container>
            <Row>
                ...
                <Col md={9}>
                <MycontactContainer favouritData={favouritData}handleRefresh={handleRefresh}/>
                </Col>
            </Row>
        </Container>
        {/* <Container>
